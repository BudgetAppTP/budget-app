...
Kľúčovou úlohou je ochrana údajov používateľov prostredníctvom moderných bezpečnostných opatrení, vrátane viacfaktorovej autentifikácie pre citlivé operácie, silných šifrovacích algoritmov TLS a spoľahlivej ochrany prihlasovacích údajov, ako sú hashované heslá a šifrované biometrické informácie.\footnote{Bezpečnosť aplikácie je hlavným zameraním druhého semestra, preto aktuálna verzia zatiaľ nespĺňa viaceré z uvedených kritérií.}
